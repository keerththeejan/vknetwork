        ...
        <form method="post" data-loading>
            ...
            <div class="row g-3">
                <div class="col-md-6">
                    ...
                    <input class="form-control" type="number" step="0.01" min="0" id="price" name="price" required value="<?= e($_POST['price'] ?? '0') ?>">
                </div>
                <div class="col-md-6">
                    <label class="form-label" for="stock">Stock</label>
                    <input class="form-control" type="number" min="0" id="stock" name="stock" required value="<?= e($_POST['stock'] ?? '0') ?>">
                </div>
            </div>
            <div class="mb-3 mt-3">
                <label class="form-label" for="low_stock_threshold">Low stock alert at or below</label>
                <input class="form-control" type="number" min="0" id="low_stock_threshold" name="low_stock_threshold" value="<?= e($_POST['low_stock_threshold'] ?? '5') ?>">
            </div>
            <div class="mb-3">
                <label class="form-label" for="category">Category</label>
                <input class="form-control" id="category" name="category" maxlength="128" value="<?= e($_POST['category'] ?? '') ?>">
            </div>
